...
<html lang="en">
   ...
   <!-- end font family -->
   <link rel="stylesheet" href="<?php echo base_url().'assets/css/3dslider.css' ?>"
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="<?php echo base_url().'assets/images/loading-img.gif'?>" alt="">
      </div>
      <!-- END LOADER -->
      <section id="top">
         <header>
                        ...
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="<?php echo site_url().'/users/login' ?>" class="login"><i class="fa fa-user"></i>Logout</a>
                              </li>
                              <li>
                                 <div class="cart-option">
                                    <a href="<?php echo site_url().'/dashboard/users' ?>"><i class="fa fa-shopping-cart"></i>Dashboard</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
                                                      ...
                                                      <div id="menCollection" class="carousel slide" data-ride="carousel">
                                                         <div class="carousel-inner">
                                                            <div class="item active">
                                                               <div class="banner-for-match"><a href="#"><img class="img-responsive" src="<?php echo base_url().'assets/images/match-banner1.jpg'?>" alt="#" /></a></div>
                                                            </div>
                                                            <!-- End Item -->
                                                            <div class="item">
                                                               <div class="banner-for-match"><a href="#"><img class="img-responsive" src="<?php echo base_url().'assets/images/match-banner1.jpg'?>" alt="#" /></a></div>
...
<!--                                 <br>
                                 <style type="text/css"> input{color: black;} </style>
                              ...
                              <li>
                                 <img src="<?php echo base_url().'assets/images/img-04.png'?>" alt="">
               ...
               <div class="col-lg-4 col-sm-4 col-xs-12">
                  <aside id="sidebar" class="left-bar">
                     <div class="banner-sidebar">
                        <img class="img-responsive" src="<?php echo base_url().'assets/images/img-05.jpg'?>" alt="#" />
                  ...
                  <aside id="sidebar" class="left-bar">
                     <div class="feature-matchs">
                        <div class="team-btw-match">
                           ...
                           <ul>
                              <li>
                                 <img src="<?php echo base_url().'assets/images/img-07_002.png'?>" alt="">
                                 <span>Portugal</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="<?php echo base_url().'assets/images/img-08.png'?>" alt="">
                                 <span>Germany</span>
                              </li>
                           </ul>
                           <ul>
                     ...
                     <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                           ...
                           <tbody>
                              <tr>
                                 <td>1</td>
                                 <td><img src="<?php echo base_url().'assets/images/img-01_004.png'?>" alt="">Liverpool</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                                 <td><img src="<?php echo base_url().'assets/images/img-02_002.png'?>" alt="">Chelsea</td>
                                 <td>10</td>
                                 <td>12</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>3</td>
                                 <td><img src="<?php echo base_url().'assets/images/img-03_003.png'?>" alt="">Norwich City</td>
                                 <td>20</td>
                                 <td>15</td>
                                 <td>20</td>
                              </tr>
                              <tr>
                                 <td>4</td>
                                 <td><img src="<?php echo base_url().'assets/images/img-04_002.png'?>" alt="">West Brom</td>
                                 <td>60</td>
                                 <td>10</td>
                                 <td>60</td>
                              </tr>
                              <tr>
                                 <td>5</td>
                                 <td><img src="<?php echo base_url().'assets/images/img-05.png'?>" alt="">Sunderland</td>
                                 <td>30</td>
                                 <td>06</td>
                                 <td>30</td>
                              </tr>
               ...
               <div class="col-lg-8 col-sm-8 col-xs-12">
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        <img class="img-responsive" src="<?php echo base_url().'assets/images/img-01_002.jpg'?>" alt="">
                     ...
                     <div class="news-post-widget">
                        <img class="img-responsive" src="<?php echo base_url().'assets/images/img-02_003.jpg'?>" alt="">
                        <div class="news-post-detail">
                           <span class="date">20 march 2016</span>
                           <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
                  ...
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        <img class="img-responsive" src="<?php echo base_url().'assets/images/img-03_003.jpg'?>" alt="">
                        <div class="news-post-detail">
                           <span class="date">20 march 2016</span>
                           <h2><a href="blog-detail.html">At vero eos et accusamus et iusto odio dignissimos ducimus</a></h2>
                           <p>Just hours after that his grandma had died, Angel Di Maria imagined how she might react if he didn't play</p>
               ...
               <div class="col-md-12">
                  <div class="full">
                     <div class="match_vedio">
                        <img class="img-responsive" src="<?php echo base_url().'assets/images/img-07.jpg'?>" alt="#" />
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="container">
                  <div class="col-md-3">
                     <div class="team-column style-2">
                        <img src="<?php echo base_url().'assets/images/img-1-1.jpg'?>" alt="">
                  ...
                  <div class="col-md-3">
                     <div class="team-column style-2">
                        <img src="<?php echo base_url().'assets/images/img-1-2.jpg'?>" alt="">
                        <div class="player-name">
                           <div class="desination-2">Defender</div>
                           <h5>Charles Wheeler</h5>
                           <span class="player-number">12</span>
                  ...
                  <div class="col-md-3">
                     <div class="team-column style-2">
                        <img src="<?php echo base_url().'assets/images/img-1-3.jpg'?>" alt="">
                        <div class="player-name">
                           <div class="desination-2">Defender</div>
                           <h5>Charles Wheeler</h5>
                           <span class="player-number">12</span>
                  ...
                  <div class="col-md-3">
                     <div class="team-column style-2">
                        <img src="<?php echo base_url().'assets/images/img-1-4.jpg'?>" alt="">
                        <div class="player-name">
                           <div class="desination-2">Defender</div>
                           <h5>Charles Wheeler</h5>
                           <span class="player-number">12</span>
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                           ...
                           <li><a href="matche.html">Recent Matches</a></li>
